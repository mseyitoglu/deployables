# Picture Carousel Static Website deployed on AWS EC2 using Cloudformation
...
|
|----readme.md         # Given to the operator (Definition of the project)          
|----cfn-template.yml  # To be delivered by operator (Cloudformation template)
|----static-web
        |----index.html  # Given to the operator (HTML file)
        |----cat0.jpg    # Given to the operator (image file)
        |----cat1.jpg    # Given to the operator (image file)
        |----cat2.jpg    # Given to the operator (image file)
```
