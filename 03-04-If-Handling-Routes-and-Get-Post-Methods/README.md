...
Purpose of the this is to get introductory knowledge of how to handle forms.

![HTTP Methods in Flask](./http-methods-flask.png)

## Outcomes

At the end, get to know:
...
## Part 5 - Use GET and POST HTTP Method
...
- Write an application with form handling and save the complete code as `app-form-handling.py` under `flask-04-handling-forms` folder.
